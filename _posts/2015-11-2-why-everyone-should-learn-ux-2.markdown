...
ลองดูนาทีที่ 9 นะครับ Satya Nadella บอกว่าหน้าที่สำคัญของ CEO คือการ “curate the culture” และ “set the tone of the company.” ผมคิดว่าถ้าต้องการทำสองอย่างนี้ให้ได้ด๊ที่สุด CEO ต้องเข้าใจผู้ใช้อย่างลึกซึ้ง Microsoft ตอนนี้สนใจ NSP (Net Promoter Score) ซึ่งเป็นตัวชี้วัดความพึงพอใจของผู้ใช้ (อยากมาใช้อีกมั๊ย อยากแนะนำคนอื่นให้มาใช้หรือเปล่า) ถ้้านี่เป็นหน้าที่หลักของ CEO ผมมองว่าการเข้าใจผู้ใช้ก่อนเป็นปัจจัยหลักในการทำหน้าที่นี้
